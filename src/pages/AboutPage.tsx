...
export function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              North Karnataka Women Entrepreneurs Development Association (WEDA) is a non-profit organization established in 2009 and registered under Charitable Acts of 1960/17, Government of Karnataka.
            </p>
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-br from-slate-50 via-orange-50/40 to-amber-50/30 relative overflow-hidden">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-orange-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Team grid: 3 per row, vertical scroll (2 rows visible) */}
          <div className="max-h-[440px] overflow-y-auto pr-2 pb-4 no-scrollbar">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 [grid-auto-rows:200px] pb-6">
            {[
              ...
              <motion.div
                ...
                className="relative overflow-hidden bg-gradient-to-br from-red-50/40 via-red-100/30 to-pink-100/25 p-4 sm:p-6 rounded-lg shadow-md border border-white/40 transition-transform duration-500 hover:-translate-y-2 group h-full"
              >
